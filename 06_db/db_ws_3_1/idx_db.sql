-- Active: 1769737648975@@127.0.0.1@3306@online_course_platform_db
...
CREATE TABLE feedback(
    ...
    FOREIGN KEY (student_id) REFERENCES feedback(id) ON DELETE CASCADE,
    FOREIGN KEY (course_id) REFERENCES feedback(id) ON DELETE CASCADE
);
