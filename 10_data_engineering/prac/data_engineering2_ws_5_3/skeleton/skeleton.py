...
with DAG(
    ...
    start_date=pendulum.datetime(2026, 5, 19, tz="Asia/Seoul"),  # DAG 실행을 시작할 기준 날짜 (2026년 5월 19일 설정)
    ...
    sequential_1 >> sequential_2 >> end  # sequential_task_1 → sequential_task_2 순서로 실행됨
    after_parallel >> end  # 마지막 태스크 실행 후 DAG 종료
