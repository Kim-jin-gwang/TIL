...
print(es.cat.nodes(h=["name", "node.role"], format="text"))
...
es.indices.put_settings(index=index_name,settings={
...
es.indices.put_settings(index=index_name, settings={
    "index.routing.allocation.include_tier_preference":"data_cold"
})
