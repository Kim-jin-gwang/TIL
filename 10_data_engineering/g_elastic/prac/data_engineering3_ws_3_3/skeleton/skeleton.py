...
# TODO: 검색 실행
text_result = es.search(index=index_name,body=text_query)
...
# TODO: term 검색 실행
kw_result = es.search(index=index_name,body=keyword_query)
...
# TODO: 정렬 쿼리 실행
sort_result = es.search(index=index_name,body=sort_query)
