...
documents = [
    ...
    { "_id": 13, "name": "삼성갤럭시 울트라 북", "brand": "Samsung", "price": 1479.99, "category": "laptop", "rating": 4.6 }
]
...
# 검색 결과에 바로 반영되도록 refresh 실행
es.indices.refresh(index="products_chapter3")

# 1. 전체 문서 개수 확인
count_result = es.count(index="products_chapter3")
